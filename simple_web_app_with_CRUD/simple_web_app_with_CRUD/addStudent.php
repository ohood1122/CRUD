...
if (!empty($_POST['class_id']) and !empty($_POST['country_id']) and !empty($_POST['name']) and !empty($_POST['date_of_birth'])) {
    addStudent((int)$_POST['class_id'], (int)$_POST['country_id'], $_POST['name'], $_POST['date_of_birth']);
}
?>
...
<body>
    ...
    <div class="mt-4 mx-3">
        <form action="addStudent.php" method="POST">
            ...
            <button type="submit" class="btn w-100 mb-5 btn-dark">
                ADD
            </button>
        </form>
    </div>
