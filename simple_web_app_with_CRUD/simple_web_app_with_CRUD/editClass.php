...
if (!empty($_POST['class_name'])) {
    updateClass($_GET['id'], $_POST['class_name']);
}
?>
...
<body>
    ...
    <div class="mt-4 mx-3">
        <!-- form -->
        <form action="editClass.php?id=<?php echo $_GET['id']; ?>" method="POST">
            <div class="py-3">
                <!-- Class name -->
                <input type="text" required class="form-control text-center" name="class_name" placeholder="Class name" />
                <!-- end Class name -->
            </div>
